...
export default function Login() {
  return (
    <div>
      <div  className='bg-[#e8e9eb] h-[90vh] w-[90vw] rounded-2xl shade-g flex'>
    ...
    <div className=' h-full w-[60vw] px-6 bg-[#E8E9EB] rounded-tr-2xl rounded-br-2xl py-5 flex flex-col gap-y-2 items-center justify-center'>
        <div className='h-[75vh] w-full flex justify-center items-center bg-[#E0DFD5] shadow-lg rounded-xl px-9 pb-4'>
            ...
            <div><button className='w-[10vw] h-10 bg-[#f1ce00] rounded-xl text-[#6e6e6e] font-semibold hover:text-[#e0dfd5] hover:bg-[#6e6e6e] transition-all'>Login</button></div>
            </div>
