...
const ConversationsItem = ({ props }) => {
  ...
  return (
    <div className={'flex flex-col items-baseline justify-start h-[7vh] py-2 pb-2 px-2 pr-1 mt-1 transition-all w-full  hover:text-[#0e0e0e] rounded-2xl ' + (lightTheme ? " hover:bg-gray-300" : " hover:bg-[rgb(240,240,240)]")} onClick={() => navigate('/app/chat')}>
